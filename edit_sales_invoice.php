...
$sql_customers = "UPDATE customers_data SET _NAME='$cus_name',MOBILE='$cus_mobile',_ADDRESS='$cus_address',_STATE='$cus_state',MODE='$PAYMENT_MODE',total_qty='$total_qty',total_amount='$total_amount',Round_Off='$Round_Off',grand_total='$grand_total' WHERE id = '".$_SESSION["id"]."' AND USERNAME = '".$_SESSION["USERNAME"]."' ";
...
$total=mysqli_real_escape_string($conn,str_replace("," ,"" , $_POST["colSix"][$a]));
$sql_order_details = "UPDATE order_data SET ITEM='$item' , HSN='$hsn' , QTY='$qty' , RATE='$rate' , TOTAL='$total' , edit='1' WHERE edit='0' AND cus_id = '".$_SESSION["id"]."' AND USERNAME = '".$_SESSION["USERNAME"]."' ORDER BY id ASC LIMIT 1";
        ...
        <div class="card-body">
          ...
          <div>
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" class="border border-primary rounded-bottom">
              <div id="tab2">
                <div class="text-center py-4 "><h4  class="border-bottom border-secondary d-inline">Sales Invoice</h4></div>
                ...
                <div class="row " style="padding:0 5%;">
                  ...
                  <div class="col-sm-6 ">
                    <div class="input-group mb-3 ">
                      <div class="input-group-prepend">
                        <span class="input-group-text  px-2.5">Address<span>*</span></span>
                      </div>
              ...
              <div class="mx-4 " id="static">
                <table id="tab3" class="table table-responsive mt-4" >
                  <thead class="text-center">
                    <tr>
                      <th width="4%">S.no</th>
                      <th width="40%">Description<span>*</span></th>
                      <th width="12%">Hsn/Code</th>
                      <th width="12%" class="text-center">Qty<span>*</span> (pcs/m)</th>
                      <th width="13%">Price<span>*</span></th>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <select class="form-control text-capitalize" id="colTwo<?php echo $j;?>" name="colTwo[]" data-type="productName" required="" onchange="selectoption(this)">
                          <option value="<?php echo $ord_row["HSN"];?>"><?php echo $ord_row["ITEM"] ;?></option>
                          <?php
                          ...
                          echo "<option value=".$itm_row["HSN"]." >".$itm_row["product"]."</option>" ;
                          }
                      ...
                      <td>
                        <input type="text" class="form-control" data-type="productTotal" id="colSix<?php echo $j;?>" name="colSix[]" value="<?php echo IND_money_format($ord_row["TOTAL"]) ;?>" tabindex="-1" readonly="">
                      </td>
                    </tr>
                  ...
                  <td colspan="1"><div class="d-flex flex-row-reverse">Round-Off<div></td>
