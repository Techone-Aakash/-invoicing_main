      ...
      <div class="card mb-4 bg-transparent">
        ...
        <div class="card-body">
          ...
          <div class="row border-bottom border-danger rounded-bottom" >
            ...
            <?php
                $sql = "SELECT * FROM customers_data WHERE (  INVOICE_ID = '$ses_id' OR id='$get_id') AND (USERNAME = '".$_SESSION['USERNAME']."' AND total_sc_gst!=0.00) ";
          ...
          <div id="tab2" class="mb-4">
            <div class="card-body">
              <div class="text-center mb-2"><h5  class="border-bottom border-secondary d-inline">GST INVOICE</h5></div>
              <div class="row  px-2" style="font-weight: 500;">
                ...
                <div class="col-sm-6 mb-1" style="border-right: 1px solid red;">
                  ...
                  <div class="row w-100 my-2">
                    <div class="col-sm-4 text-secondary" >Phone no</div>
                  ...
                  <div class="row w-100 my-2">
                    ...
                    <div class="col-sm-8 text-center border-bottom border-dark text-capitalize "><?php echo $row["_ADDRESS"]; ?></div>
                  </div>
                </div>
                <div class="col-sm-6 mb-1">
                  <div class="row w-100 my-2">
                    <div class="col-sm-3 text-secondary" >GSTIN</div>
                    <div class="col-sm-9 border-bottom border-dark text-center text-uppercase"><?php echo $row["GSTIN"]; ?></div>
                  </div>
                  <div class="row w-100 my-2">
                    <div class="col-sm-3 text-secondary" >E-mail</div>
                    <div class="col-sm-9 border-bottom border-dark text-center text-capitalize "><?php echo $row["EMAIL"]; ?></div>
                  </div>
                  <div class="row w-100 my-2">
                ...
                <div class="mx-4 overflow-auto" id="static">
                  <table id="tab3" class="table table-responsive mt-4 " >
                    <thead class="text-center ">
                      <tr>
                        <th width="5%">S.no</th>
                        <th class="28%">Description</th>
                        <th width="10%">Hsn/<br>Code</th>
                        <th width="10%">Qty<h6 style="font-size:.75rem; font-weight:700;">(pcs/m)</h6></th>
                        <th width="10%">Price</th>
                        <th width="10%">Gst<br/><h6 style="font-size:.75rem; font-weight:700;">(in %)</h6></th>
                        <th width="10%">GST<h6 style="font-size:.75rem; font-weight:700;">(SGST+CGST)</h6></th>
                    ...
                    <tbody id="mytable">
                      ...
                      <tr>
                        ...
                        <td><?php echo IND_money_format($row1["GST"]*2).'%'; ?></td>
                        <td><?php echo IND_money_format($row1["S_C_GST"]*2); ?></td>
                    ...
                    <tr>
                      ...
                      <td><?php echo IND_money_format($row["total_sc_gst"]); ?></td>
                    </tr>
                    <tr>
                      <td colspan="4">
                        <?php
