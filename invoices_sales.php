                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php if ($row["MODE"] != "Cancelled"){ ?>
                                        ...
                                        <td class='text-center px-2'><a href='print.php?id=<?php echo $row["id"];?>' class="text-decoration-none"><input type="hidden" name="id" value=$id><i class="fa fa-print text-primary mx-1"></i>Print</a></td>                                   

                                        <td class='text-center px-2'><a href='edit_sales_invoice.php?id=<?php echo $row["id"];?>' class="text-decoration-none"><input type="hidden" name="id" value=$id alt="print"><i class="fa fa fa-edit text-success mx-1" ></i>Edit</a></td>
                                        
                                        <td class='text-center px-2'><a href='delete_sales_Invoice.php?id=<?php echo $row["id"];?>' class="text-decoration-none" onclick="return confirm('Would you want to delete this?');"><input type="hidden" name="id" value=$id><i class="fa fa-times text-danger mx-1"></i>Cancel</a></td>
                                    <?php }else{ ?>

                                        <td colspan="3" class='text-center px-2'><a href='print.php?id=<?php echo $row["id"];?>' class="text-decoration-none"><input type="hidden" name="id" value=$id><i class="fa fa-print text-primary mx-1"></i>Print</a></td>
